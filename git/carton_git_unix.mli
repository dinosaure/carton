...
module Make (Uid : Carton.UID) : sig
  val make : Store.t -> idx:(Fpath.t -> Fpath.t) -> (Fpath.t, Lwt_unix.file_descr, Uid.t) t Lwt.t
  ...
  val get
    :  Store.t
    -> resources:((Lwt_unix.file_descr * int64)
  ...
  val fds : (Fpath.t, Lwt_unix.file_descr, Uid.t) t -> (Lwt_unix.file_descr * int64) list
end
